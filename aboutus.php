<!DOCTYPE html>
<html style="height: 1500px; filter: blur(0px);">
...
<body>
    <div>
        <div class="header-dark" style="height: 100px; width: 500px;">
            <nav class="navbar navbar-dark navbar-expand-md navigation-clean-search">
                <div class="container">
                    <a class="navbar-brand" href="index.php">MMDU Event</a>
                    ...
                    <div class="collapse navbar-collapse" id="navcol-1">
                        ...
                        <span class="navbar-text">
                            ...
                            if (isset($_SESSION['mail']) == '' && isset($_SESSION['password']) == '') {
                                echo "<a class='login' href='login.php'>Log In</a></span>";
                                echo "<a class='btn btn-light action-button' role='button' href='signup.php'>Sign Up</a>";
                            } else {
    ...
    <div class="team-boxed">
        <div class="container">
            ...
            <div class="row people" style="height: 400px; width: 950px;">
            ...
            <div class="container">
                <div class="row justify-content-center">
                    <div class="col-sm-4 col-md-3 item">
                        <h3>Team</h3>
                        <ul>
                            <li><a href="https://www.instagram.com/anshul.sharma23/">Anshul Sharma</a></li>
